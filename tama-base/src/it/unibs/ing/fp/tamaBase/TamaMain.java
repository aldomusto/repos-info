...
public class TamaMain {
	...
	public static void main(String[] args) {
		...
		do {
			...
			switch (scelta) {
				case 1:
					int n_carezze = InputDati.leggiIntero(String.format("Quante carezze vuoi dargli (da 1 a %d) = ",MAX_CAREZZE), 1, MAX_CAREZZE);
					tama1.daiCarezza(n_carezze);
				break;
				case 2:
					int n_biscotti = InputDati.leggiIntero(String.format(("Quanti biscotti vuoi dargli (da 1 a %d) = "),MAX_BISCOTTI), 1, MAX_BISCOTTI);
